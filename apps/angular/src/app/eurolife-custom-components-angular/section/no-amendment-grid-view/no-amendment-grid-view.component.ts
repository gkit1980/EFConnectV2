...
@Component({
  selector: 'app-no-amendment-grid-view',
  templateUrl: './no-amendment-grid-view.component.html',
  styleUrls: ['./no-amendment-grid-view.component.scss']
})
export class NoAmendmentGridViewComponent extends SectionComponentImplementation implements OnInit{ 
  ...
  get showSection(): boolean {
      ...
      if(this.context.iceModel.elements["amendments.showAmendments"].getValue().forIndex(null)==false)
      return true;
      else 
      return false;
    }
