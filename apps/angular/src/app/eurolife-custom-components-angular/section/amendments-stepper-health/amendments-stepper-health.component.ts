...
@Component({
  selector: "app-amendments-stepper-health",
  templateUrl: "./amendments-stepper-health.component.html",
  styleUrls: ["./amendments-stepper-health.component.scss"]
})
export class AmendmentsStepperHealthComponent extends SectionComponentImplementation {
  stepperState: any = {
