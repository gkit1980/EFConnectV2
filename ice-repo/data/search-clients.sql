  SELECT client_id, man_id, pid, NAME, TYPE, MAX(city) AS city,
          ...
          SELECT c.client_id, c.man_id, p.egn AS pid, NVL(pc.NAME, p.NAME) AS NAME, pmc.NAME AS TYPE, a.city,
          ...
          GROUP BY client_id, man_id, pid, NAME, TYPE
