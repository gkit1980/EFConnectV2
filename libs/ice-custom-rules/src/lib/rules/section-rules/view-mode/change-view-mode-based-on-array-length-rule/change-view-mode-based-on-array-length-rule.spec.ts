import { ChangeViewModeBasedOnArrayLengthViewRule } from './change-view-mode-based-on-array-length-rule';
...
describe(ChangeViewModeBasedOnArrayLengthViewRule.name, () => {
        ...
        pageRecipeBuilder
          .section(sectionRecipeBuilder =>
            sectionRecipeBuilder
              ...
              .viewModeRule(ChangeViewModeBasedOnArrayLengthViewRule.name, ruleRecipe)
          )
          .section(sectionRecipeBuilder =>
  ...
  const getSectionWithTheViewmodeRule = (iceModel: IceModel) => {
    ...
    const sectionWithViewModeRule = testPage.sections.find(
      section => section.viewModeRule.ruleName === ChangeViewModeBasedOnArrayLengthViewRule.name
    );
