...
@Component({
  selector: 'app-lifecycle-line-chart',
  templateUrl: './lifecycle-line-chart.component.html',
  styleUrls: ['./lifecycle-line-chart.component.scss']
})
export class LifecycleLineChartComponent extends SectionComponentImplementation {
