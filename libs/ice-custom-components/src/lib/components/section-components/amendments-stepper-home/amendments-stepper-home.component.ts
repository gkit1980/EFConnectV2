...
@Component({
  selector: "app-amendments-stepper-home",
  templateUrl: "./amendments-stepper-home.component.html",
  styleUrls: ["./amendments-stepper-home.component.scss"]
})
export class AmendmentsStepperHomeComponent extends SectionComponentImplementation {
  stepperState: any = {
