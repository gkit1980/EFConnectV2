...
@Component({
  selector: "app-amendments-stepper-life",
  templateUrl: "./amendments-stepper-life.component.html",
  styleUrls: ["./amendments-stepper-life.component.scss"]
})
export class AmendmentsStepperLifeComponent extends SectionComponentImplementation {
  stepperState: any = {
